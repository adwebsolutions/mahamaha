            ...
            if( ! function_exists( 'woocommerce_get_product_thumbnail' ) ) {
                function woocommerce_get_product_thumbnail( $size = 'shop_catalog', $placeholder_width = 0, $placeholder_height = 0  ) {
                    ...
                    if( $product->price and $product->is_in_stock() and $product->product_type == 'simple' ) {
                        $output .= '<li data-product_id="' . $product->id . '" class="add_to_cart_button ajax_add_to_cart bw-woo-button-cart' . ( Bw_woo::is_product_in_cart( $product->id ) ? ' added' : '' ) . '"><img src="' . BW_URI_ASSETS . 'img/cart_white.png" alt=""></li>';
                    }
