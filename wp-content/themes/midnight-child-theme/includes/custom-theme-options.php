...
function child_theme_options() {
  ...
  $custom_settings = array(
      ...
      'settings'        => array(
          ...
          array(
              'id'          => 'top_bar_label',
              'label'       => 'Label for social content',
              'desc'        => '',
              'std'         => '',
              'type'        => 'text',
              'section'     => 'header_layout',
          ...
          array(
              'id'          => 'contact_top_bar_content',
              'label'       => 'Contact Custom text',
              'desc'        => '',
              'std'         => '',
              'type'        => 'text',
              'section'     => 'header_layout',
