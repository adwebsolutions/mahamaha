...
<?php endif; ?>
		...
		<h2 class="bw-title-inner"><?php _e( 'Sign in', 'midnight' ); ?></h2>
        
        <span class="bw-title-inner-sub"><?php _e( 'Login using social media', 'midnight' ); ?></span>
		...
		<form method="post" class="login">
			...
			<p class="form-row">
				...
				<input type="submit" class="button" name="login" value="<?php esc_attr_e( 'Login Now', 'midnight' ); ?>" />
			</p>
