...
<?php if( is_wc_endpoint_url("order-received") ): ?>
    ...
    <?php if( ! ( isset( $_GET['payu_in_status'] ) and $_GET['payu_in_status'] == 'failed' ) ): ?>
        <div class="bw-order-received">
            <img src="<?php echo get_stylesheet_directory_uri(); ?>/img/order-received.png" alt="">
            <h2><?php esc_html_e('Thank you for shopping with us, your order is complete!', 'midnight'); ?></h2>
