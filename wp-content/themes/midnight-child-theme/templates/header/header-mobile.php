<div class="bw-hm">
    <div class="bw-hm-top">
        ...
        <a class="bw-hm-user" href="<?php echo get_permalink( get_option('woocommerce_myaccount_page_id') ); ?>">
            ...
            <div class="bw-hm-username"><?php echo is_user_logged_in() ? esc_html( $current_user->display_name ) : 'Entrar / Registrarse';  ?></div>
        </a>
        <?php endif; ?>
        ...
        <div class="bw-hm-icons">
            ...
            <?php if( $woo_active and Bw_woo::wishlist_active_plugin() ): ?>
                ...
                <a href="<?php echo ! empty( $yith_page_id ) ? get_permalink( $yith_page_id ) : '#'; ?>">
                    <i class="bw-hm-icon bw-hm-icon-wish"><img src="<?php echo get_stylesheet_directory_uri() . '/img/wishlist_green.png'; ?>" alt=""></i>
                </a>
            <?php endif; ?>
            <?php if( $woo_active ): ?>
                <a href="<?php echo WC()->cart->get_cart_url(); ?>">
                    <i class="bw-hm-icon bw-hm-icon-cart"><img src="<?php echo get_stylesheet_directory_uri() . '/img/cart_green.png'; ?>" alt=""></i>
                </a>
            <?php endif; ?>
            <i class="bw-hm-icon bw-hm-icon-menu"><img src="<?php echo get_stylesheet_directory_uri() . '/img/menu_green.png'; ?>" alt=""></i>
        </div>
    </div>
    <div class="bw-hm-nav">
